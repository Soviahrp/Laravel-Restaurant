...
@section('title', 'image: ' . $image->name)
           ...
           <table class="table table-striped">
            ...
            <tr>
                ...
                <td width="60%">
                    ...
                    width="20%" target="_blank">
                </td>
            </tr>
            <tr>
                <th>Created At</th>
                <td>{{ date('Y-m-d H:i:s', strtotime($image->created_at)) }}</td>
            </tr>
            <tr>
                <th>Updated At</th>
                <td>{{ date('Y-m-d H:i:s', strtotime($image->updated_at)) }}</td>
            </tr>
           </table>
           <div class="float-end mt-2">
                <a href="{{ route('panel.image.edit', $image->uuid) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
           </div>
        </div>
    </div>
@endsection
