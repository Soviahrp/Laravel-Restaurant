                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="position" id="position" class="form-select @error('position') is-invalid @enderror">
                            ...
                            <option value="Patissier" {{ old('position', $chef->position) == 'Patissier' ? 'selected' : ''}}>Patisier</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="insta_link" id="insta_link" class="form-control @error('insta_link') is-invalid @enderror"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="linked_link" id="linked_link" class="form-control @error('linked_link') is-invalid @enderror"
